...
Connection.prototype.connectRedis = function (config, callback) {
  ...
  // 'error' handler supresses uncaughtException exceptions in the caller
  client.on('error', function (err) {
    logging.error('Redis client: error:', err.message);
  });
...
Connection.prototype.connectSentinel = function (config, callback) {
  ...
  sentinel.on('error', function (err) {
    logging.error('Sentinel client: error:', err.message);
  });
